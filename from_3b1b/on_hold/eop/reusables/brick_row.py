...
class BrickRow(VMobject):
    ...
    def get_rects_for_level(self, r):
        ...
        for k in range(r + 1):
            ...
            new_rect = Rectangle(width=proportion * self.width,
                                 height=self.height,
    ...
    def get_outcome_rects_for_level(self, r, inset=False, with_labels=False):
        ...
        if inset == True:
            outcome_width = self.outcome_shrinkage_factor_x * float(
                self.width) / (2**r)
        ...
        rect = RoundedRectangle(width=outcome_width,
...
class SplitRectsInBrickWall(AnimationGroup):
    def __init__(self, mobject, **kwargs):
        ...
        for k in range(0, r):
            ...
            subdiv = DashedLine(mobject.get_top() + x * RIGHT,
