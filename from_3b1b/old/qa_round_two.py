...
class PowersOfTwo(Scene):
    def construct(self):
        ...
        curr_po2_outline.set_color_by_gradient(YELLOW, RED, PINK, PURPLE, BLUE,
                                               GREEN)
...
class PiHoldingScreen(PiCreatureScene):
    def construct(self):
        ...
        self.play(ShowCreation(screen), morty.change, "raise_right_hand",
                  screen)
        self.wait(10)
        self.play(morty.change, "hooray", words[0], Write(words[0]))
        self.wait(10)
        self.play(morty.change, "pondering", words[1],
