...
class IntroScene(PiCreatureScene):
    ...
    def build_up_sum_on_number_line(self):
        ...
        self.number_line = NumberLine(
            ...
            unit_size=5,
            tick_frequency=0.2,
            line_to_number_buff=MED_LARGE_BUFF).shift(LEFT)
    ...
    def other_pi_formulas(self):
        ...
        self.play(FadeOut(self.rects), FadeOut(self.number_line_labels),
                  FadeOut(self.number_line), FadeOut(self.little_euler_terms),
                  FadeOut(self.ellipsis), FadeOut(self.arrow))
...
class FirstLighthouseScene(PiCreatureScene):
    ...
    def show_lighthouses_on_number_line(self):
        ...
        for (i,
             light_source) in zip(list(range(NUM_VISIBLE_CONES, NUM_CONES)),
...
class SingleLighthouseScene(PiCreatureScene):
    ...
    def setup_elements(self):
        ...
        self.screen = Rectangle(width=0.06,
                                height=2,
...
class EarthScene(Scene):
    def construct(self):
        ...
        self.sun = LightSource(opacity_function=lambda r: 0.5,
...
class ScreenShapingScene(ThreeDScene):
    ...
    def setup_elements(self):
        ...
        # screen
        self.screen = Line([3, -self.screen_height / 2, 0],
    ...
    def slant_screen(self):
        ...
        self.slanted_screen = Line(lower_slanted_screen_point,
    ...
    def prove_inverse_square_law(self):
        ...
        self.play(FadeOut(reading21), FadeOut(reading22), FadeOut(reading23),
                  FadeOut(reading24), FadeOut(midline1), FadeOut(midline2))
...
class IPTScene1(PiCreatureScene):
    def construct(self):
        ...
        self.play(ls2.move_source_to, H, SwitchOff(ls1.ambient_light),
...
class IPTScene2(Scene):
    def construct(self):
        ...
        reading1 = TexMobject("{1\over a^2}").scale(formula_scale).move_to(
            indy1)
        indy1.add(reading1)
        ...
        reading2 = TexMobject("{1\over b^2}").scale(formula_scale).move_to(
            indy2)
        indy2.add(reading2)
        ...
        reading3 = TexMobject("{1\over h^2}").scale(formula_scale).move_to(
            indy3)
        indy3.add(reading3)
...
class InscribedAngleScene(ThreeDScene):
    def construct(self):
        ...
        self.play(FadeOut(one_left), FadeOut(one_right),
                  FadeOut(diameter_text), FadeOut(arc_left),
                  FadeOut(arc_right))
